...
#     def __init__(self, user_id: int, first_name: str, last_name: str, address: str, credit_card_info_id: int, payment_type: str, status: int, amount: Decimal):
